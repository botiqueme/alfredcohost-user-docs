...
To delete a property, go to **Manage my properties**, find the property you want to delete, and click the <img src="../media/delete-icon.png" alt="trash icon" style="height: 1em; vertical-align: middle;"> icon:
