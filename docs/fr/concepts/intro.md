...
# Comprendre le fonctionnement d'Alfred

Vous ne savez pas par où commencer ? Cette page vous présente les concepts clés d'Alfred et les bases du fonctionnement de la plateforme — en termes simples et concrets.
...
<div class="ts-guides-grid">
  ...
  <a class="card ts-guide-card" href="#/fr/concepts/hands_off_c.md">
    <h3>Hands off</h3>
    <p>Comment Alfred transfère les conversations à votre équipe lorsque les voyageurs ont besoin d'aide humaine.</p>
  </a>
